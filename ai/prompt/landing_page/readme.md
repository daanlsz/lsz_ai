...
-  **行业经验**
当用户第一次看到这个产品时，他需要知道产品的价值和优势。
这个页面应该怎么讲故事、怎么建立信任、怎么促使下载
landing page
1. 详细的、好看的展示内容
2. url 方便分享，二维码扫码
3. SEO 搜索引擎优化，
...
vibe coding的方式 逐步引导llm 完成工作
不要宽泛模糊的也行、

—— 为一款名为Foodize的外卖送餐手机应用编写一个落地页代码
vibe coding 边写边改

上一轮里，豆包产出了纯html/css/js页面，对于快速原型没问题。真想变成一个接近生产环境的结果，技术栈 react+ts+tailwindcss,落地页项目工程。
